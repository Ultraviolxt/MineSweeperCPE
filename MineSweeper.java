...
public class MineSweeper extends MainMethod {
    ...
    private int boardWidth;  // ความกว้างของกระดาน
    private int boardHeight; // ความสูงของกระดาน
    ...
    public void initGame() {
        ...
        boardWidth = numCols * tileSize; // ความกว้างของกระดาน
        boardHeight = numRows * tileSize; // ความสูงของกระดาน
